...
port=8083 # set if using tgi
master_port=29489 # set if using tgi
mem_frac=0.7
num_seq=10 # set to 10 for sc-cot
# model=Intel/neural-chat-7b-v3-3
model=model_checkpoints/neural-chat-7b-v3-3_self_BSDetector_pureNLI # trained with self-gen labels
sharded=false
requests=256
